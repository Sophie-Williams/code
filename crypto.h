...
namespace Crypto {
	...
	public:
		...
		bool acquired() { return hCryptProv != NULL; };
	...
	public:
		...
		bool available() { return hHash != NULL; };
		DWORD get_hash_size();
	...
	public:
		...
		bool available() { return hCryptKey != NULL; };
	...
	public:
		...
		bool available() { return hKey != NULL; };
		void release();
	...
	public:
		...
		bool available() { return context.acquired(); };
	private:
		CryptContext context;
	};
